...
describe('Create account, login and check token', () => {
    ...
    it('it should register, login, and check token', (done) => {
        chai.request(server)
            ...
            .end((err, res) => { //when we get a response from the endpoint, in other words, the res object should have a status of 200
                ...
                .end((err, res) => {
                    ...
                    chai.request(server)
                        ...
                        .end((err, res) => {
                            ...
                            done(); //dont forget the done callback to indicate were done
                    })
                })
